...
class FavoritesHandler(context: Context) :
    ...
    fun addRoutine(routine: FavoritesModel): Long {
        ...
        contentValues.put(KEY_NOTIFICATION_TEXT, routine.notificationText)
    ...
    fun viewRoutine(): ArrayList<FavoritesModel> {
        val routineList: ArrayList<FavoritesModel> = ArrayList<FavoritesModel>()
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                notificationText =
                    cursor.getString(cursor.getColumnIndexOrThrow(KEY_NOTIFICATION_TEXT))
    ...
    fun deleteRoutine(routine: FavoritesModel): Int {
        val db = this.writableDatabase
